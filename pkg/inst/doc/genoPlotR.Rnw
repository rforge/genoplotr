...
Finally, the plot is drawn, addind a title. The different options can be
checked by removing/adding the different arguments. New windows can be opened
by using \code{x11()} or \code{window()}, depending on the OS.
